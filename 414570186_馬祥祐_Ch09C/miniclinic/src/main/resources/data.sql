...
-- 💡 強制更新密碼：因為前面的 INSERT OR IGNORE 會略過已存在的舊資料，這幾行確保密碼一定會更新
UPDATE doctor SET password_hash = '$2a$10$XhyEgd4qh5TXJa7NkMg3gOqsJxATykAyJERH7ZqTD7eEPVlcmgewm' WHERE doctor_id = 'D001';
UPDATE doctor SET password_hash = '$2a$10$/x/fVm66HZJWeeYZRUbPp..gS9Czgs3a27RjYQPs75obpRoUWU9ZC' WHERE doctor_id = 'D002';
UPDATE doctor SET password_hash = '$2a$10$4fZBPZq1NJmqW5MUgOUsqukV6OiTJutAKR/WbiFiQ6PRTjFbNsMFy' WHERE doctor_id = 'D003';
UPDATE doctor SET password_hash = '$2a$10$ZlsUgEo2MOm0RYxwcP55qukrjipEXYNKyyRfdIKkOEv7RpuXEPhxK' WHERE doctor_id = 'D004';
UPDATE doctor SET password_hash = '$2a$10$XsgY9Cmk7PqJ2pve2k4xwuTnV/hakC6LOGJqicQyjH.wDiM7PQhWa' WHERE doctor_id = 'D005';
